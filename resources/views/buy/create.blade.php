                        ...
                        <div class="w-screen rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 ">
                            <div class="p-6 space-y-5 md:space-y-6 sm:p-8">
                                <form  method="POST" action="{{ route('users.store') }}" class="space-y-4 md:space-y-6" action="Post">
                                    @csrf
                                    <div>
                                        <label for="name" class="block mb-1 text-sm font-medium text-gray-900 dark:text-gray-700">Buyer Name</label>
                                    ...
                                    <button type="submit" class="w-full text-white bg-lime-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">SAVE</button>
                                </form>
                            </div>
                        </div>
                    </div>
