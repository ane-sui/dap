                ...
                <div class="flex flex-col">
                    ...
                    <div class="inline-block min-w-full align-middle">
                        <div class="overflow-hidden ">
                            <x-primary-button><a href="{{route('crops.create')}}">Add Crops</a></x-primary-button>
                            <table class="min-w-full mt-4 rounded-xl">
                                <thead>
                                    <tr class="bg-gray-50">
                                        ...
                                        <th scope="col" class="p-5 text-sm font-semibold leading-6 text-left text-gray-900 capitalize">Seed Type</th>
                                        <th scope="col" class="p-5 text-sm font-semibold leading-6 text-left text-gray-900 capitalize">Planting Date</th>
