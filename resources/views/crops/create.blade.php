            ...
            <form action="{{route('crops.store')}}" method="post">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="farm_id" hidden value="{{$farm->id}}">
                    <div>
                        <label for="planting" class="block mb-2 text-sm font-medium ">Date Of Planting</label>
                        <input type="date" name="planting" max="<?=date('m-d-y')?>" id="planting" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  dark:focus:ring-primary-500 dark:focus:border-primary-500" required="">
                    </div>
                </div>
