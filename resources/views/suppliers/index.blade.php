                ...
                <div class="flex flex-col">
                    ...
                    <div class="inline-block min-w-full align-middle">
                        <div class="overflow-hidden ">
                            <x-primary-button><a href="{{route('suppliers.create')}}">Add Products</a></x-primary-button>
                            <table class="min-w-full mt-4 rounded-xl">
                                <thead>
                                    <tr class="bg-gray-50">
                                        <th scope="col" class="p-5 text-sm font-semibold leading-6 text-left text-gray-900 capitalize rounded-t-xl">Product Name </th>
                                ...
                                <tbody class="divide-y divide-gray-300 ">
                                    ...
                                    <tr class="transition-all duration-500 bg-white hover:bg-gray-50">
                                        ...
                                        <div class="flex items-center gap-1">
                                                <a href="{{route('suppliers.show',$supplier)}}"  class="flex p-2 underline transition-all duration-500 rounded-full group item-center">
                                                    View                                                    </a>
