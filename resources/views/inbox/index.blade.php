                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="inline-block min-w-full align-middle">
                                        <div class="overflow-hidden ">
                                            <x-primary-button class="bg-teal-700"><a href="{{route('extensions.create')}}">Message-Extension-Worker</a></x-primary-button>
                                            <table class="min-w-full mt-4 rounded-xl">
                                                ...
                                                <tbody class="divide-y divide-gray-300 ">
                                                    ...
                                                    <tr class="transition-all duration-500 bg-white hover:bg-gray-50">
                                                        <td class="p-2 text-sm font-medium leading-6 text-gray-900 whitespace-nowrap ">{{$msg->created_at->format('d-M-Y')}}</td>
                                                        <td class="p-2 text-sm font-medium leading-6 text-gray-900 whitespace-nowrap ">{{$msg->subject}}</td>

                                                        <td class="p-2 ">
                                                            <div class="flex items-center gap-1 ">
                                                                <a href="{{route('inbox.show',$msg)}}"  class="flex p-2 text-teal-600 transition-all duration-500 rounded-full group item-center hover:p-4">View</a>
                                                                @role('bank')
                                                                <div class="flex p-2 transition-all duration-500 rounded-full group item-center hover:p-4">
                                                                    <form action="{{route('inbox.destroy',$msg)}}" method="POST" class="inline-block">
                                                                        @csrf
                                                                        @method('Delete')
