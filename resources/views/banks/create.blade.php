                    ...
                    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                        <div class="w-screen rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 ">
                            <div class="p-6 space-y-5 md:space-y-6 sm:p-8">
                                <form  method="POST" action="{{ route('bank.store') }}" class="space-y-4 md:space-y-6" action="Post">
                                    @csrf
                                    <div>
                                        <label for="name" class="block mb-1 text-sm font-medium text-gray-900 dark:text-gray-700">Bank Name</label>
