                                        ...
                                        <header class="mb-2 not-format">
                                            <address class="flex items-center mb-6 not-italic">
                                                <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                                                    <div class="">
                                                        <a href="#" rel="author" class="text-xl  text-end font-bold text-gray-900 ">Written by: {{$blog->user->name}}</a>
                                                        {{-- <p class="text-base text-gray-500
                                                        dark:text-gray-400"></p> --}}
                                                        <p class="text-base text-gray-500 dark:text-gray-400"><time pubdate datetime="2022-02-08" title="February 8th, 2022">Date: {{$blog->created_at->format('d M Y ')}}</time></p>
                                                    </div>
                                                </div>
                                            </address>
